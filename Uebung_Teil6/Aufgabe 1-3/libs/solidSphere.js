...
function SolidSphere(gl, latitudeBands, longitudeBands, color) {
    ...
    function defineVertices(latitudeBands, longitudeBands) {
        "use strict";
        ...
        for (var latNumber = 0; latNumber <= latitudeBands; latNumber++) {
            ...
            for (var longNumber = 0; longNumber <= longitudeBands; longNumber++) {
                ...
                var x = cosPhi * sinTheta - 1;
                var y = cosTheta + 1.2;
                var z = sinPhi * sinTheta + 0.2;
    ...
    var vertices = defineVertices(latitudeBands, longitudeBands);
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices.vertices), gl.STATIC_DRAW);


    sphere.bufferNormals = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, sphere.bufferNormals);
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices.normals), gl.STATIC_DRAW);
